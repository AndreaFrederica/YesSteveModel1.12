...
public class SyncModelFiles {
    ...
    public static void encode(SyncModelFiles message, PacketBuffer buf) {
    ...
    public static SyncModelFiles decode(PacketBuffer buf) {
    ...
    private static void sendModelFiles(String[] md5Info, ServerPlayerEntity sender) {
    ...
    private static void sendPassword(ServerPlayerEntity sender) {
        try {
