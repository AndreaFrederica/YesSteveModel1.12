...
public class CompositeAnimationController<T extends AnimatableEntity<?>> implements IAnimationController<T> {
    ...
    public String getCurrentAnimationName() {
        if (this.initialized) {
            return this.animationRuntime.isBuiltinAnimation() ? "[builtin] " + this.controller.getCurrentAnimation() : this.animationRuntime.getCurrentAnimationName();
        }
        return this.controller.getCurrentAnimationName();
    }
    ...
    @Override
    public void setAnimation(String animationName, @Nullable com.elfmcys.yesstevemodel.geckolib3.core.builder.ILoopType loopType) {
        this.controller.setAnimation(animationName, loopType);
    }

    @Override
    public void setAnimation(String animationName) {
        this.controller.setAnimation(animationName);
    }

    @Override
    public void setTransitionLengthTicks(float ticks) {
        this.controller.setTransitionLengthTicks(ticks);
    }
    ...
    public void stopTransition() {
        this.controller.stopTransition();
    }
