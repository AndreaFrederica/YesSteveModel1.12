...
public final class ProjectileAnimationController {
    ...
    private ProjectileAnimationController() {
    }
    ...
    private static class ProjectileAnimationDataProvider implements AnimationDataProvider<ProjectileModelBundle> {
        private static final ProjectileAnimationDataProvider INSTANCE = new ProjectileAnimationDataProvider();
