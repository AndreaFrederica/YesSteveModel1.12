...
public class NamedModelProcessor<T extends GeoEntity<?>, TModel> implements ModelProcessor<T, TModel> {
    ...
    private final BiFunction<String, T, com.elfmcys.yesstevemodel.geckolib3.core.controller.IAnimationController<T>> controllerFactory;

    public NamedModelProcessor(String prefix, String slotName, String[] requiredAnimations, boolean checkAnimationEntries, AnimationDataProvider<TModel> animationDataProvider, BiFunction<String, T, com.elfmcys.yesstevemodel.geckolib3.core.controller.IAnimationController<T>> controllerFactory) {
