...
public class CityHash {
    ...
    public Number128 hash128(String raw) {
        ...
        int len = byteArray.length;
        return len >= 16 ? hash128WithSeed(byteArray, 16, new Number128(fetch64(byteArray, 0), fetch64(byteArray, 8) + k0)) : hash128WithSeed(byteArray, 0, new Number128(k0, k1));
    }
    ...
    private Number128 hash128WithSeed(final byte[] byteArray, int start, final Number128 seed) {
        ...
        return new Number128(hashLen16(x + v.getHiValue(), w.getHiValue()) + y, hashLen16(x + w.getHiValue(), y + v.getHiValue()));
    }
